...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var dropdownItemsTipe = document.querySelectorAll('.dropdown-item.item-tipe-dokumen');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var dropdownItemsJenis = document.querySelectorAll('.dropdown-item.item-jenis-dokumen');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var dropdownItemsStatus = document.querySelectorAll('.dropdown-item.item-status');
